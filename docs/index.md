...
- **[Examples](examples/basic-deduplication.md)** - Practical examples with code
- **[Guides](guides/choosing-window-size.md)** - How-to guides for common tasks
- **[Reference](reference/cli.md)** - Complete API and CLI reference
